// =============================================================================
// ColdChainID — ESP32 | SETOR: Câmara Fria (Etapa 2 de 3)
// Arquitetura: Máquina de Estados Finitos (FSM)
//
// Sequência obrigatória: Produção → Câmara Fria → Expedição
// Este setor só aceita tags cuja etapa anterior é "Produção".
//
// Estados da FSM:
...
// --- Configuração OTA ---
const char* hostName    = "ESP32-CAMARA-FRIA"; 
...
const char* SETOR = "Câmara Fria";

// --- Regra de sequência: etapa que deve ter ocorrido ANTES desta ---
const char* ETAPA_ANTERIOR_PERMITIDA = "Produção";
...
// --- Chaves AES-128 ---
const char* chave_aes = "XXXXXXXXXXXXXX";
const char* iv_aes    = "XXXXXXXXXXXXXX";
...
void reconnect() {
  ...
  if (client.connect("ESP32_ColdChain_CamaraFria", mqtt_user, mqtt_pass)) {
...
void setup() {
  ...
  Serial.println("=== SETOR: Camara Fria (Etapa 2/3) | FSM iniciada ===");
